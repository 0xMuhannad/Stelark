...
namespace Stelark.Core
{
    public class GlobalState
    {
        ...
        public string LocalCAServerName { get; set; } = string.Empty;
        ...
        public long MaxMemoryUsageMB { get; set; } = 3072;
        ...
        public int IntenseModeProcessedCount { get; set; } = 0;
    ...
    public class TemplateCache
    {
        ...
        public bool IsValid => DateTime.Now.Subtract(CacheTime).TotalMinutes < 30;
