...
{
    /// <summary>
    /// Stelark - Compromise Assessment Tool for Detecting AD CS Attacks
    ...
    public class Program
    {
        ...
        public static async Task<int> Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine("Stelark Compromise Assessment Tool for Detecting AD CS Attacks");
        ...
        private static void PrintHelpMessage()
        {
            ...
            Console.WriteLine("Version: 1.4");
            Console.WriteLine("==============================");
            Console.WriteLine("A compromise assessment tool for detecting Active Directory Certificate Services (AD CS) attacks.");
            Console.WriteLine("\nUSAGE:");
